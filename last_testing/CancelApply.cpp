...
void CancelApply::cancelApply(GeneralMember* cur_mem, string business_number, MemberDB& mem_db) {
	...
	cur_mem->deleteApplication(cancle_app); // 1.1.3

	vector<Member*>& member_list = mem_db.getMemberList();
