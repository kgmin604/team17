...
public:
	...
	void addApplication(Application* new_app);				// 인자로 받은 Application 객체를 app_list_에 추가
	void deleteApplication(Application* del_app);			// 인자로 받은 Application 객체를 app_list_에서 삭제 후 해당 객체 반환
