...
public:
    ...
    void addApplication(Application* newApp);                                                       // 인자로 받은 newApp을 app_collection_에 추가
    void deleteApplication(Application* delApp);                                                    // 인자로 받은 newApp을 app_collection_에 추가
    int getNumberOfApps();
};
